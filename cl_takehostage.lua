	...
	if not takeHostage.InProgress and canTakeHostage then			
		...
		if closestPlayer then
			...
			if targetSrc ~= -1 then
				...
				TriggerServerEvent("tZRP400:sync",targetSrc)
...
RegisterNetEvent("tZRP400:syncTarget")
AddEventHandler("tZRP400:syncTarget", function(target)
...
RegisterNetEvent("tZRP400:releaseHostage")
AddEventHandler("tZRP400:releaseHostage", function()
...
RegisterNetEvent("tZRP400:killHostage")
AddEventHandler("tZRP400:killHostage", function()
	takeHostage.InProgress = false 
	takeHostage.type = ""
...
RegisterNetEvent("tZRP400:cl_stop")
AddEventHandler("tZRP400:cl_stop", function()
	takeHostage.InProgress = false
	takeHostage.type = "" 
	ClearPedSecondaryTask(PlayerPedId())
	DetachEntity(PlayerPedId(), true, false)
	...
	while true do 
		if takeHostage.type == "agressor" then
			...
			if IsEntityDead(PlayerPedId()) then	
				...
				TriggerServerEvent("tZRP400:releaseHostage", takeHostage.targetSrc)
			end 
			...
			elseif IsDisabledControlJustPressed(0,74) then --kill 			
				...
				TriggerServerEvent("tZRP400:killHostage", takeHostage.targetSrc)
				TriggerServerEvent("tZRP400:stop",takeHostage.targetSrc)
				Wait(100)
